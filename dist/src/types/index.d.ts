 ...
 */
export declare const DecimalDefaultPrecision = 15;
/**
 * Enumeración de porcentajes de impuestos.
 */
export declare enum TaxPercentageEnum {
    /**
     * No hay impuestos (0%).
     */
    T0 = 0,
 ...
 */
export declare enum FountTypeEnum {
    /**
 ...
 */
export declare enum ChargeApplicationEnum {
    /**
     * Porcentaje
     */
    PERCENTAGE = 1,
